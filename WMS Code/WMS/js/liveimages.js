...
function periodical_ajax_request() {
    ...
    if (Online == true) {
        ...
        if (UI_relatedCameraInfoObjectsList.length > 0) {
            ...
            from_datetime.setMinutes(from_datetime.getMinutes() - 10);// To get the Images of Last 3  Minutes Latest Images ...
            ...
            $.ajax(
                   {
                           ...
                           if (data.d != null) {
                               if (data.d.length > 0) {
                                   ...
                                   for (var Camitr = 0; Camitr < ActualImagesOfRequestedCameras.length; Camitr++) {
                                       ...
                                       if (periodical_responseobj[Camitr].Online_Sts === "1") /* Camera is Working & Posting Images */ {
                       ...
                       complete: function () {
                           ...
                           setTimeout(periodical_ajax_request, 6000); /* Requests for every 30 seconds */
